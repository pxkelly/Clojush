...
(def problem-map ;[multiple-inputs-bool multiple-outputs-bool data-domains test-case-generator]
  {;"bouncing-balls" [true false clojush.problems.software.benchmarks-v2.bouncing-balls/bouncing-balls-data-domains clojush.problems.software.benchmarks-v2.bouncing-balls/bouncing-balls-test-cases]
  ...
  ;;  "camel-case" [false false clojush.problems.software.benchmarks-v2.camel-case/camel-case-data-domains clojush.problems.software.benchmarks-v2.camel-case/camel-case-test-cases]
  ;;  "coin-sums" [false true clojush.problems.software.benchmarks-v2.coin-sums/coin-sums-data-domains clojush.problems.software.benchmarks-v2.coin-sums/coin-sums-test-cases]
  ;;  "cut-vector" [false true clojush.problems.software.benchmarks-v2.cut-vector/cut-vector-data-domains clojush.problems.software.benchmarks-v2.cut-vector/cut-vector-test-cases]
  ;;  "dice-game" [true false clojush.problems.software.benchmarks-v2.dice-game/dice-game-data-domains clojush.problems.software.benchmarks-v2.dice-game/dice-game-test-cases]
  ;;  "fizz-buzz" [false false clojush.problems.software.benchmarks-v2.fizz-buzz/fizz-buzz-data-domains clojush.problems.software.benchmarks-v2.fizz-buzz/fizz-buzz-test-cases]
  ;;  "gcd" [true false clojush.problems.software.benchmarks-v2.gcd/gcd-data-domains clojush.problems.software.benchmarks-v2.gcd/gcd-test-cases]
  ;;  "leaders" [false false clojush.problems.software.benchmarks-v2.leaders/leaders-data-domains clojush.problems.software.benchmarks-v2.leaders/leaders-test-cases]
  ;;  "luhn" [false false clojush.problems.software.benchmarks-v2.luhn/luhn-data-domains clojush.problems.software.benchmarks-v2.luhn/luhn-test-cases]
  ...
  ;;  "shopping-list" [true false clojush.problems.software.benchmarks-v2.shopping-list/shopping-list-data-domains clojush.problems.software.benchmarks-v2.shopping-list/shopping-list-test-cases]
   "snow-day" [true false clojush.problems.software.benchmarks-v2.snow-day/snow-day-data-domains clojush.problems.software.benchmarks-v2.snow-day/snow-day-test-cases]
   "solve-boolean" [false false clojush.problems.software.benchmarks-v2.solve-boolean/solve-boolean-data-domains clojush.problems.software.benchmarks-v2.solve-boolean/solve-boolean-test-cases]
   "spin-words" [false false clojush.problems.software.benchmarks-v2.spin-words/spin-words-data-domains clojush.problems.software.benchmarks-v2.spin-words/spin-words-test-cases]
   "substitution-cipher" [true false clojush.problems.software.benchmarks-v2.substitution-cipher/substitution-cipher-data-domains clojush.problems.software.benchmarks-v2.substitution-cipher/substitution-cipher-test-cases]
   "twitter" [false false clojush.problems.software.benchmarks-v2.twitter/twitter-data-domains clojush.problems.software.benchmarks-v2.twitter/twitter-test-cases]
   "vector-distance" [true false clojush.problems.software.benchmarks-v2.vector-distance/vector-distance-data-domains clojush.problems.software.benchmarks-v2.vector-distance/vector-distance-test-cases]
...
(comment
  ...
  (let [namespace
    ...
    (generate-data-for-data-sets namespace (str "C:/Users/theki/Desktop/generate_data_test/" namespace)))
